...
let favoriteFoods = ['Pizza','Noodles','Pasta','Quesadilla'];
...
//Below line of the code is to verify that dessert added is the correct one in the favoriteFoods array
console.log('Added food was', favoriteFoods[favoriteFoods.length - 1]);
//
...
let entree = 'Caramel Frappe';
favoriteFoods.unshift(entree);
console.log(`Added a drink to beginning: ${favoriteFoods}`);
